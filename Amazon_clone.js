...
const PRODUCTS = [
	{
		...
		description: 'High-performance laptop with RTX 4070 GPU, 16GB RAM, and 1TB SSD for ultimate gaming.',
		price: 69999,
		rating: 4.8,
		reviews: 2156,
	...
	},
	{
		...
		category: 'Electronics',
		description: 'Premium true wireless earbuds with active noise cancellation and 40h battery life.',
		price: 3499,
		rating: 4.6,
		reviews: 1823,
		image: './img/wireless_earbuds.jpg'
	},
	{
		id: 'p3',
		name: 'Leather Jacket Classic',
		category: 'Fashion',
		description: 'Genuine leather jacket with quilted lining, perfect for casual and formal wear.',
		price: 5899,
		rating: 4.4,
		reviews: 987,
		image: './img/leather_jacket.jpg'
	},
	{
		id: 'p4',
		...
		rating: 4.3,
		reviews: 1456,
		image: './img/urban_sneakers.jpg'
	},
	{
		id: 'p5',
		name: 'Coffee Maker Deluxe',
		category: 'Home & Kitchen',
		description: 'Programmable coffee maker with thermal carafe and grinder, brews up to 12 cups.',
		price: 4999,
		rating: 4.5,
		reviews: 742,
		image: './img/coffee_maker.jpg'
	},
	{
		id: 'p6',
		name: 'Standing Desk Adjustable',
		category: 'Home & Kitchen',
		description: 'Electric height-adjustable desk with memory presets and sturdy build.',
		price: 2999,
		rating: 4.7,
		reviews: 1123,
		image: './img/standing_desk.jpg'
	},
	{
		id: 'p7',
	...
	},
	{
		...
		description: 'Non-slip yoga mat made from natural rubber, 6mm thick for comfort.',
		price: 899,
		rating: 4.5,
		reviews: 1897,
		image: './img/yoga_mat.jpg'
	}
];
		...
		card.innerHTML = `
			<button data-id="${p.id}" class="block text-left w-full">
				...
				<div class="p-3">
					...
					<h3 class="mt-0.5 text-sm font-semibold line-clamp-2">${p.name}</h3>
			...
			<div class="p-3 pt-0">
				<button data-add="${p.id}" class="w-full h-9 bg-amber-500 hover:bg-amber-600 text-white text-sm font-medium rounded-md">Add to Cart</button>
			</div>
		`;
...
function updateAuthButton() {
	...
	btn.textContent = state.user ? `Hello, ${state.user.email}` : 'Sign In';
	btn.title = state.user ? 'Click to Sign out' : 'Sign in or Create account';
}
